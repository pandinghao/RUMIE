...
ADAPTER_DIR="LVLM_RUMIE/saves/InternVL3_5-4B_UMIE/checkpoint-${STEP}"
MERGED_DIR="LVLM_RUMIE/merge_output/InternVL3_5-4B_UMIE_${STEP}"
...
# 结果根目录
RES_ROOT="LVLM_RUMIE/results/roubust_results/InternVL3_5-4B_UMIE_${STEP}"

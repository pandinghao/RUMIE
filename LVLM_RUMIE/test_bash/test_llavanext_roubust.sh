...
ADAPTER_DIR="LVLM_RUMIE/saves/llavanext_UMIE/checkpoint-${STEP}"
MERGED_DIR="LVLM_RUMIE/merge_output/llavanext_UMIE_${STEP}"
...
# 结果根目录
RES_ROOT="LVLM_RUMIE/results/roubust_results/llavanext_UMIE_${STEP}"

...
OUT_BASE_DIR="LVLM_test_datasets/MNRE-V1"

# 原始图片目录（给 text_noise 用）
ORIG_IMAGE_DIR="datasets/MNRE-V1/mnre_image/img_org/test"

# 视觉扰动目录（MNRE-V1）
VISION_NOISE_BASE="rumie_datasets/MNRE-V1/rule_vision_noise"
VISION_INPUT_FILE="data_process/processed_data/relation/MNRE-V1/test.fixed.jsonl"   # 你之前用的那个
#VISION_PERTS=("color_shift" "gaussian_noise" "jpeg_compression" "low_resolution")

# 文本扰动目录（MNRE-V1）
TEXT_NOISE_BASE="rumie_datasets/MNRE-V1/text_noise"
#TEXT_PERTS=("extend_sentence" "replace_triple" "Text-Side_Contradictory_Perturbation")
TEXT_PERTS=(Text-Side_Contradictory_Perturbation)     # e.g., ("change_context" "swap_entity")
VISION_PERTS=("color_shift" "gaussian_noise" "jpeg_compression" "low_resolution" "Image-Side-Contradictory_Perturbation_clip")  
